...
<head>
  ...
  $(document).ready(function() {
    ...
    $("#hailait").click(function(){ 
    	$("#bilde").addClass("highlighted");
        });

 	$("#nolait").click(function(){ 
    	$("#bilde").removeClass("highlighted");
        });
    });
</script>
...
<div class = "row fonakrasa"> 
	<div class = "col-md-6">
		<div class = "caption">
			<p align = "middle">Niks: Gļota</p>
			<p align = "middle">E-pasts: (neredzams)</p>
			<p align = "middle">Dzīvesvieta: Latvija</p>
			<p align = "middle">Draugi: 0</p>
			<p align = "middle">Mīļākā spēle: Final Fantasy</p>
		</div>
	</div>	

	<div class = "col-md-6">
		<div class = "caption">
			<p align = "right"><img src = "./bildes/profils.jpg" width = "250px" height = "250px" id = "bilde"> </p>
			<button type="button" class="btn pull-right btn-primary" id = "hailait">Skaista bilde</button>
			<button type="button" class="btn pull-right btn-primary" id = "nolait">Neglīta bilde</button>
		</div>
	</div>	
